...
public class JwtTokenUtil implements Serializable {
    ...
    private static final long SESSION_VALIDITY = 2 * JWT_TOKEN_VALIDITY;
    ...
    public Boolean canTokenBeRefreshed(String token) {
        ...
        // Token can be refreshed up to one minute before its actual expiration time
        return  new Date(System.currentTimeMillis() - JWT_TOKEN_VALIDITY).before(issuedAt)
